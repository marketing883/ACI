  ...
  return (
    <section className="py-20 bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid gap-6 ${showWhitepaper ? 'lg:grid-cols-3' : 'md:grid-cols-2 lg:grid-cols-4'}`}>
          {/* News Column */}
          <div className={showWhitepaper ? 'lg:col-span-2' : ''}>
            <div className={`grid gap-6 ${showWhitepaper ? 'md:grid-cols-2' : 'md:grid-cols-2 lg:grid-cols-4'}`}>
