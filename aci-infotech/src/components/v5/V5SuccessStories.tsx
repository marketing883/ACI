...
import { STORIES, SUCCESS_STORY_SLUGS, type StoryFacts } from './success-stories-data';
...
// Re-exported so existing importers of this component keep working; the
// values themselves live in the server-safe data module.
export { SUCCESS_STORY_SLUGS };
