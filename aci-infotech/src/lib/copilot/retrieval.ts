...
const PLATFORM_KEYWORDS: Record<PlatformId, readonly string[]> = {
  ...
  gcp: ['gcp', 'google cloud', 'bigquery', 'vertex ai', 'dataflow', 'looker'],
...
const INDUSTRY_KEYWORDS: Record<IndustryId, readonly string[]> = {
  ...
  energy: ['energy', 'utilities', 'grid', 'renewables', 'smart meter', 'derms'],
  'oil-gas': ['oil and gas', 'oil & gas', 'upstream', 'downstream', 'refinery', 'wellhead', 'scada', 'pi historian'],
