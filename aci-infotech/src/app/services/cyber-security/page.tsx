...
const faqs = [
  ...
  },
  {
    ...
    answer: "Both. We design, implement, and operate 24/7 SOC coverage on LogRhythm, Splunk, Microsoft Sentinel, CrowdStrike, and PagerDuty. The same engineers who built your security controls stay on the console post-deployment. For the broader picture including NOC, follow the sun coverage, and incident handoff between operations and security, see our Managed Operations practice.",
  },
];

const socCapabilities = [
  'Tier 1 through Tier 3 analyst coverage, 24/7, with weekly threat hunts',
  'Incident response playbooks tied to your compliance obligations',
  'Audit evidence prepared for SOC 2, ISO 27001, HIPAA, and PCI-DSS reviews',
  'P1 containment targets measured in minutes, reported monthly',
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[var(--aci-secondary)] mt-3 mb-4">
                Security monitoring that runs on your&nbsp;stack.
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                We operate the SOC for clients who need 24/7 threat detection and
                incident response without standing up the capability in house. Same
                engineers who designed your controls stay on the console post-deployment.
              </p>

              <ul className="space-y-3 mb-8">
                {socCapabilities.map((item) => (
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="lg"
                  className="text-[var(--aci-primary)] border-[var(--aci-primary)] hover:bg-[var(--aci-primary)]/5"
                >
                  Talk to a SOC Architect
                </Button>
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              <div className="bg-gradient-to-br from-[var(--aci-secondary)] to-gray-900 rounded-2xl p-8 shadow-2xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="text-sm text-gray-400">24/7 Security Operations</div>
                </div>
                <div className="space-y-4">
                  <div className="flex gap-2">
                    {['Endpoints', 'Identity', 'Network', 'Cloud'].map((src) => (
                  ...
                  <div className="bg-[var(--aci-primary)]/20 rounded-lg p-4 text-center">
                    <div className="text-[var(--aci-primary-light)] font-medium">SIEM & Detection</div>
                    <div className="text-xs text-gray-400 mt-1">LogRhythm • Splunk • Sentinel</div>
                  </div>
                  <div className="text-center text-gray-500">↓</div>
                  <div className="bg-[var(--aci-primary)]/30 rounded-lg p-4 text-center">
                    <div className="text-white font-bold">Triage & Response</div>
                    <div className="text-xs text-gray-300 mt-1">Tier 1 to Tier 3 analysts on shift</div>
                  </div>
                  <div className="text-center text-gray-500">↓</div>
                  <div className="flex gap-2">
                    {['Contained', 'Documented', 'Audit-ready'].map((dest) => (
