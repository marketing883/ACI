...
const services = [
  ...
  },
  {
    ...
    description: 'Quality as an engineering discipline, not a test phase. AI-augmented, continuous, and owned by the team that ships. In-sprint automation, agentic AI coverage, CI/CD quality gates, and observability-fed quality.',
    capabilities: ['In-Sprint Test Automation', 'Agentic AI Coverage', 'CI/CD Quality Gates', 'Observability-Fed Quality'],
    technologies: ['Playwright', 'Cypress', 'Mabl', 'k6', 'OWASP ZAP', 'GitHub Actions'],
