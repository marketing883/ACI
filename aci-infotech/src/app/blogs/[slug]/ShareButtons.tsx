...
export default function ShareButtons({ title }: { title: string }) {
  ...
  const iconButton =
    'p-2.5 rounded-full border border-gray-200 text-gray-500 transition-colors hover:border-blue-700 hover:text-blue-700';

  return (
    <div className="mt-8 border-t border-gray-200 pt-8">
      <div className="flex flex-wrap items-center gap-5">
        <span className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-700">/ Share</span>
        <div className="flex flex-wrap gap-2">
          ...
          <button onClick={shareOnWhatsApp} className={iconButton} title="Share on WhatsApp">
          ...
          <button
            ...
            className={
              copied
                ? 'p-2.5 rounded-full border border-[#84CC16] bg-[#84CC16] text-black transition-colors'
                : iconButton
            }
